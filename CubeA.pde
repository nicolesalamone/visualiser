...
class CubeA {
  ...
  CubeA(float w, float h, float d) {
    ...
    quadBG[0] = color(0);
    quadBG[1] = color(51);
    quadBG[2] = color(100,100,100);
    quadBG[3] = color(153);
    quadBG[4] = color(204);
    quadBG[5] = color(100,100,100);
  ...
  void display() {
    ...
    rotateX(hatSize/2*PI/rotation.x);
    rotateY(hatSize/2*PI/rotation.y);
    rotateZ(hatSize/2*PI/rotation.z);
    noStroke();
